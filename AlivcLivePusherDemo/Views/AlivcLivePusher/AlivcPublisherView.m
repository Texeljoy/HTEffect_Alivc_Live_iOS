...
- (void)setupTopViews {
    ...
    self.snapshotButton = [self setupButtonWithFrame:(CGRectMake(CGRectGetWidth(self.frame) - retractX - topViewButtonSize, 0, topViewButtonSize, topViewButtonSize))
                                       normalImage:[UIImage imageNamed:@"screenshot"]
                                       selectImage:nil
                                            action:@selector(snapshotButtonAction:)];
    [self.topView addSubview:self.snapshotButton];
    
    self.switchButton = [self setupButtonWithFrame:(CGRectMake(CGRectGetMinX(self.snapshotButton.frame) - retractX - topViewButtonSize, 0, topViewButtonSize, topViewButtonSize))
